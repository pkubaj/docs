...
* VP4650 - Intel Core i5-10210U (both v1 and v2 versions, for details please
    see https://github.com/intel/FSP/tree/master/CometLakeFspBinPkg#differentiating-cometlake1-and-cometlake2)
* VP4670 - Intel Core i7-10810U (both v1 and v2 versions)
